...
Account.create(number: 123452, member: matt, bank: chase)
matt.accounts.create(number: 456456, bank: wells_fargo)
chase.accounts.create(number: 790345, member: derek)
tony.accounts.create(number: 192342, bank: wells_fargo)
